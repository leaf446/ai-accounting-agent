...
```
📊 투자등급: B   — 판정 분포: B 8표             (확신도 90%, 사실상 만장일치)
📊 부정위험: B   — 판정 분포: C 3표 · B 2표 · A 1표 (확신도 70%, 판단 갈림!)
```
...
| 이정확 (재무분석가) | qwen2.5:7b | 재무비율 해석 |
| 박의심 (부정탐지전문가) | mistral:7b | 부정위험 평가 — 감사의 '전문가적 의구심' 역할 |
