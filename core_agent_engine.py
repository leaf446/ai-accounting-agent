...
"""
        ...
        consensus_prompt += f"""
다음 두 항목으로 균형잡힌 최종 결론을 제시해주세요:
1. 최종 등급과 다수 의견의 핵심 근거 (2~3문장)
2. 소수 의견 고려사항: 다수와 다른 등급을 지지할 수 있는 구체적인 지표나
   관점이 있다면, 어떤 요소를 중시하면 어떤 등급이 가능한지 실제 근거를 들어
   1~2문장으로 서술 (없으면 '해당 없음'이라고만 쓰세요)
"""
